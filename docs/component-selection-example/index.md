...
<!-- Outer layout table: left = power table, right = explanation -->
<table style="width:100%;">
  <tr>
    <!-- LEFT: Power budget table -->
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>0.5A</td>
            <td>1.3A</td>
            <td>typical (1.3A is worst case scenario)
            </td>  
          </tr>
          <tr>
 ...
 <!-- EXPLANATION (RIGHT SIDE) -->
    <td style="width:45%; vertical-align:top; padding-left:16px;">
     ...
     The process for determining the final power budget involved looking through the BOM for our project, and finding datasheets for the given components. We also found information from websites that sell the components, as well as user reviews that confirmed the values we were seeing across multiple sites.
      ...
      <p>
      After thorough research was conducted, the final results for our power budget were a minimum of <strong>3.532</strong> Amps, and a maximum of <strong>5.6235</strong> Amps. These values were used to determine which power source we would be purchasing. We ended up going with a <strong>12V, 5.2A</strong> power supply, in the form of a rechargeable li-ion battery.
      </p>
